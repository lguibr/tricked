...
def test_apply_move() -> None:
    ...
    state = GameState(pieces=[25, 1, 2], board_state=0, current_score=0)
    # Piece 25 is a 1-triangle piece requiring pointing UP at (0,0,0) offset
    # Let's find a valid placement from the mask using bitwise ops
    from tricked.env.pieces import STANDARD_PIECES

    p0_masks = STANDARD_PIECES[25]
