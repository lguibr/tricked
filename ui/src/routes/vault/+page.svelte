...
<div class="p-6 md:p-10 min-h-full flex flex-col items-center">
	<div
		class="w-full max-w-7xl mb-10 border-b border-outline-variant/30 pb-6 flex justify-between items-end"
	>
		<div>
			<div class="flex items-center gap-3 mb-2">
				...
				>
				<h1
					class="text-3xl font-headline font-bold text-on-surface uppercase tracking-tight glow-cyan"
				>
