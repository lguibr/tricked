    ...
    const singleGroups: GroupDef[] = [
        {
            ...
            fields: [
                ...
                { key: "timeout", label: "Timeout (Secs)", min: 10, max: 7200, step: 60 },
                { key: "maxSteps", label: "Steps Per Trial", min: 1, max: 100, step: 1 },
            ]
        },
        {
            ...
            color: "text-zinc-300",
            fields: [
                { key: "resnetBlocks", label: "ResNet Blocks", min: 2, max: 30, step: 1 },
                { key: "resnetChannels", label: "ResNet Channels", min: 32, max: 512, step: 32 },
            ]
        }
    ];
    ...
    const boundGroups: GroupDef[] = [
        {
            ...
            fields: [
                { key: "num_processes", label: "Worker Processes", min: 1, max: 128, step: 1 },
                { key: "train_batch_size", label: "Train Batch Size", min: 64, max: 4096, step: 64 },
            ]
        },
        {
            title: "MCTS Bounds",
            ...
            <DialogContent className="sm:max-w-[700px] max-h-[90vh] flex flex-col pt-6 pb-4">
                ...
                <div className="flex-1 overflow-y-auto px-4 -mx-4 pb-12 pt-2">
                    <FieldGroup className="gap-4">
                        <ParameterForm mode="single" value={config} onChange={setConfig} groups={singleGroups} />
                        <ParameterForm mode="bounds" value={config} onChange={setConfig} groups={boundGroups} />
                    </FieldGroup>
                </div>
