...
impl PinnedBatchTensors {
    pub fn new(batch_size: usize, unroll: usize, device: Device) -> Self {
        ...
        Self {
            ...
            transition_states: pin(&[batch_size as i64, unroll as i64, 20, 8, 16], Kind::Float),
            loss_masks: pin(&[batch_size as i64, (unroll + 1) as i64], Kind::Float),
            importance_weights: pin(&[batch_size as i64], Kind::Float),
        }
    }

    pub fn copy_from_unpinned(&mut self, batch: &crate::train::buffer::replay::BatchTensors) {
        ...
        self.transition_states.copy_(&batch.transition_states_batch);
...
impl GpuBatchTensors {
    pub fn new(batch_size: usize, unroll: usize, device: Device) -> Self {
        Self {
            ...
            transition_states: Tensor::zeros(
    ...
    pub fn copy_from_pinned(&mut self, pinned: &PinnedBatchTensors) {
        ...
        self.transition_states.copy_(&pinned.transition_states);
