...
pub struct StorageArrays {
    ...
    pub value_prefixs: Vec<half::f16>,
    pub policies: Vec<[u8; 288]>,
    pub values: Vec<half::f16>,
    pub td_targets: Vec<half::f16>,
...
impl StorageArrays {
    pub fn new(buffer_capacity_limit_limit: usize) -> Self {
        Self {
            ...
            value_prefixs: vec![half::f16::ZERO; buffer_capacity_limit_limit],
            policies: vec![[0; 288]; buffer_capacity_limit_limit],
            values: vec![half::f16::ZERO; buffer_capacity_limit_limit],
            td_targets: vec![half::f16::ZERO; buffer_capacity_limit_limit],
...
pub struct SharedState {
    ...
    pub array_contention_us: std::sync::atomic::AtomicU64,
    pub contention_us: std::sync::atomic::AtomicU64,
...
mod tests {
    ...
    fn test_cross_shard_history_reads() {
        let state = SharedState {
            ...
            source_run_id: "test".to_string(),
            source_run_name: "test".to_string(),
