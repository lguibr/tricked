    ...
    loop {
        ...
        for _ in 0..1000 {
            ...
            episode_steps.push(crate::train::buffer::GameStep {
                ...
                is_terminal: next_game_state.terminal,
            });
        ...
        if episode_step_count > 0 {
            ...
            experience_buffer.add_game(crate::train::buffer::OwnedGameData {
                source_run_id: experience_buffer.state.source_run_id.clone(),
                source_run_name: experience_buffer.state.source_run_name.clone(),
                run_type: experience_buffer.state.run_type.clone(),
                difficulty: configuration.environment.difficulty,
