    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="flex items-center space-x-3 shrink-0 font-medium">
          ...
          <div className="flex items-center w-[50px] text-zinc-400">
            <span className="font-bold">{process.memory_mb.toFixed(0)}</span>
            <span className="text-[7.5px] ml-0.5 opacity-50 uppercase font-black">
              RAM
            </span>
          </div>
          {process.vram_mb !== undefined && process.vram_mb > 0 && (
            <div className="flex items-center w-[50px] text-purple-400">
              <span className="font-bold">{process.vram_mb.toFixed(0)}</span>
              <span className="text-[7.5px] ml-0.5 opacity-50 uppercase font-black">
                VRAM
              </span>
            </div>
